...
private fun createSqlDriver(application: Application): SqlDriver = AndroidSqliteDriver(
    schema = SVPoliticianDatabase.Schema,
    context = application,
    name = "com.miguelaboliveira.svpolitician.data.database",
    callback = object : AndroidSqliteDriver.Callback(SVPoliticianDatabase.Schema) {
